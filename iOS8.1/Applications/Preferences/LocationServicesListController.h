...
@class ACAccount, ACAccountStore, FMFDevice, FMFSession, NSArray, NSDate, NSDictionary, NSMutableArray, NSMutableDictionary, NSNumber, NSOperationQueue, NSString, UIActionSheet, UIAlertView;
...
@interface LocationServicesListController : PSListController <FMFSessionDelegate>
{
    ...
    _Bool _locationDetailSpecifiersGroupOptional;
