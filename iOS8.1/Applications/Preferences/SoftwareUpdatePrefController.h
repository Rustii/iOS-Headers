...
@class NSDateComponentsFormatter, NSError, NSMutableArray, NSString, NSURL, PSSpecifier, RUILoader, SUDescriptor, SUDownload, SUManagerClient, SUMutableDownloadMetadata, SUTitleCell, UIAlertView, UINavigationController;
...
@property(copy, nonatomic) id devicePasscodeCompletion; // @synthesize devicePasscodeCompletion=_devicePasscodeCompletion;
...
- (void)promptForDevicePasscodeFromSpecifier:(id)arg1 withCompletion:(id)arg2;
