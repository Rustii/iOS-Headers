...
- (void)_removeMessages:(id)arg1 handler:(id)arg2;
- (void)_updateMessages:(id)arg1 handler:(id)arg2;
- (void)_addMessages:(id)arg1 handler:(id)arg2;
- (void)_setMessages:(id)arg1 handler:(id)arg2;
