...
@class FavoriteItem, MailboxListViewControllerMail, NSArray, NSMutableDictionary, NSString;
...
- (void)_pushMailboxContentViewControllerIfNecessaryAnimated:(_Bool)arg1;
