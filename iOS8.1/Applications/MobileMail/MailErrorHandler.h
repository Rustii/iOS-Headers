...
- (void)_promptUserToTryAlternateSettingsAccount:(id)arg1 newAccount:(id)arg2 withError:(id)arg3 completionHandler:(id)arg4;
- (void)_attemptHealOfAccount:(id)arg1 withAlternateAccount:(id)arg2 completion:(id)arg3;
...
- (void)healAccount:(id)arg1 withError:(id)arg2 completionHandler:(id)arg3;
