...
@class BBObserver, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString;
...
- (void)_nts_getAccountsExcludedFromUnreadCount:(out id *)arg1 includeUnreadVIPs:(out _Bool *)arg2;
