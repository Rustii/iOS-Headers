...
@class MailboxCellDeleteScanLineView, NSIndexPath, NSString, SwipeActionPullView, UIPanGestureRecognizer;
...
- (void)resetSwipedRowAnimated:(_Bool)arg1 withCompletion:(id)arg2;
...
- (void)_moveCell:(id)arg1 toSwipeOffset:(double)arg2 animated:(_Bool)arg3 usingSpringWithStiffness:(double)arg4 completion:(id)arg5;
- (void)_moveCell:(id)arg1 toSwipeOffset:(double)arg2 animated:(_Bool)arg3 completion:(id)arg4;
...
@property(nonatomic) id <MFMailboxTableViewDelegate> delegate;
