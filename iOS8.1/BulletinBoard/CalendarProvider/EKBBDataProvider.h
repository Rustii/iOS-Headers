...
- (void)performCalendarItemForBulletin:(id)arg1 action:(id)arg2;
- (void)acknowledgeAlert:(id)arg1 performActions:(id)arg2;
- (void)_bulletinRequestAcknowledged:(id)arg1 alertInfo:(id)arg2 performActions:(id)arg3;
