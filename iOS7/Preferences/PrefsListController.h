...
- (void)insertMovedThirdPartySpecifiersAtStartIndex:(unsigned long long)arg1 usingInsertBlock:(id)arg2 andExistenceBlock:(void)arg3;
- (id)_specifierDictionaryForDeveloperBundlePath:(id)arg1 identifier:(id)arg2;
- (id)_specifierDictionaryForBundlePath:(id)arg1 identifier:(id)arg2 internalIcon:(_Bool)arg3;
- (_Bool)_showCarrier;
